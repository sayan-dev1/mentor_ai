...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const navItems = [
    ...
    { name: 'Codebase Agent', path: '/codebase', icon: Code, color: 'text-amber-400', badge: 'Coding AI' },
  ...
  return (
    <>
      ...
      >
        ...
        {/* Footer Status Box & Made By Credit */}
        <div className="p-3 border-t border-white/10 space-y-2.5">
          ...
          {/* Made by GitHub Profile Link */}
          <div className="flex items-center justify-center pt-1 text-xs text-slate-400">
            {isCollapsed ? (
              <a
                href="https://github.com/sayan-dev1"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-xl bg-slate-900/80 border border-white/5 text-slate-300 hover:text-white hover:bg-slate-800 transition-colors"
                title="Made by sayan-dev1 on GitHub"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 font-medium text-slate-400 hover:text-indigo-400 transition-colors group text-[11px]"
              >
                <span>Made by</span>
                <GithubIcon className="w-3.5 h-3.5 text-slate-300 group-hover:scale-110 group-hover:text-indigo-400 transition-all" />
                <span className="font-semibold text-slate-300 group-hover:text-indigo-400 hover:underline">sayan-dev1</span>
              </a>
            )}
          </div>
        </div>
